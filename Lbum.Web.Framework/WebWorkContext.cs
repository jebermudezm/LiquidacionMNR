...
using Lbum.Core;
using Lbum.Core.Security;
using Lbum.Core.Http;

namespace Lbum.Web.Framework
{
    /// <summary>
    ...
    public partial class WebWorkContext : IWorkContext
    {
        ...
        {
            var cookieName = $"{LbumCookieDefaults.Prefix}{LbumCookieDefaults.CustomerCookie}";
        ...
        Customer IWorkContext.CurrentCustomer { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }

        Customer IWorkContext.OriginalCustomerIfImpersonated => throw new NotImplementedException();

        Vendor IWorkContext.CurrentVendor => throw new NotImplementedException();

        Language IWorkContext.WorkingLanguage { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        Currency IWorkContext.WorkingCurrency { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        TaxDisplayType IWorkContext.TaxDisplayType { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        bool IWorkContext.IsAdmin { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
