...
using Lbum.Web.Framework.Mvc.ModelBinding;
using Lbum.Web.Framework.Mvc.Routing;
using Lbum.Web.Framework.Security.Captcha;
using Lbum.Web.Framework.Themes;
using StackExchange.Profiling.Storage;
using WebMarkupMin.AspNetCore3;
using WebMarkupMin.NUglify;

namespace Lbum.Web.Framework.Infrastructure.Extensions
{
    /// <summary>
