...
using Lbum.Web.Framework.Models;
using Lbum.Web.Framework.Mvc.Filters;
using Lbum.Web.Framework.UI;

namespace Lbum.Web.Framework.Controllers
{
    /// <summary>
    /// Base controller
    /// </summary>
    ...
    public abstract class BaseController : Controller
    {
        ...
        public virtual void SaveSelectedPanelName(string tabName, bool persistForTheNextRequest = true)
        {
            ...
            //"GetSelectedPanelName" method of \Lbum.Web.Framework\Extensions\HtmlExtensions.cs
        ...
        {
            //keep this method synchronized with
            //"GetSelectedTabName" method of \Lbum.Web.Framework\Extensions\HtmlExtensions.cs
            if (string.IsNullOrEmpty(tabName))
            {
