...
using Lbum.Web.Framework.Events;
using Lbum.Web.Framework.Models;

namespace Lbum.Web.Framework.Components
{
    /// <summary>
    ...
    public abstract class NopViewComponent : ViewComponent
    {
        private void PublishModelPrepared<TModel>(TModel model)
        {
            ...
            //as we do in the /Lbum.Web.Framework/Mvc/Filters/PublishModelEventsAttribute.cs for controllers
