...
namespace Lbum.Core.Infrastructure
{
    ...
    public interface IEngine
    {
        ...
        void ConfigureServices(IServiceCollection services, IConfiguration configuration, LbumConfig nopConfig);
        ...
        /// <param name="nopConfig">Nop configuration parameters</param>
        void RegisterDependencies(ContainerBuilder containerBuilder, LbumConfig nopConfig);
    }
}
