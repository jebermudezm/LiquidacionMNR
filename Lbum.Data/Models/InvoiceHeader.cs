...
namespace Lbum.Data.Models
{
    public partial class InvoiceHeader
    {
        ...
        {
            TblDetalleFactura = new HashSet<InvoiceDetail>();
        }
        ...
        public virtual ConsecutiveDocument IdConsecutivoNavigation { get; set; }
        public virtual Department IdDepartamentoCorrespondenciaNavigation { get; set; }
        public virtual Client IdEmpresaReceptoraNavigation { get; set; }
        public virtual EnergyMeter IdFronteraNavigation { get; set; }
        public virtual City IdMunicipioInstalacionNavigation { get; set; }
        public virtual ICollection<InvoiceDetail> TblDetalleFactura { get; set; }
    }
}
